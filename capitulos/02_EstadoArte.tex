...
de respuesta \textit{UDP}. Por lo tanto la programación deberá de ser pensada en función de los eventos 
disponibles.
...
por GitHub arrojará una gran cantidad de gente que aporta nuevos scripts a Bro. Ahora lo ideal sería incorporar 
un módulo, de forma que si el resto de la comunidad lo desea pueda hacer uso de él, solamente llamando a las 
funciones que forman ese módulo.
...
\intro Tenemos que \textbf{x} e \textbf{y} son los flujos a comparar, \textbf{NIP(x,y)} es el número 
