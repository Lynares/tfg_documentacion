...
sobre los eventos usados, el evento new_connection es muy útil, pues se 
ejecuta cada vez que llega un flujo que no ha sido usado antes y además 
reconoce TCP, UDP e ICMP. El evento connection_timeout aunque sólo sirva 
...
Por último el evento connection_state_removed se lanza para TCP, UDP e ICMP 
